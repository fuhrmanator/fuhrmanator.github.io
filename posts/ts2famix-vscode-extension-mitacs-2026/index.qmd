...
Once the extension was extracted and installable, the next step was making it publicly available through the VSCode Marketplace under the publisher account `Leo-maure`[^marketplace].
...
[^marketplace]: <https://marketplace.visualstudio.com/items?itemName=Leo-maure.ts2famix-vscode-extension>
