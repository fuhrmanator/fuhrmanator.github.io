...
> This blog entry is in French, and presents a summary report about ÉvalueTonSavoir ([GitHub](https://github.com/ets-cfuhrman-pfe/EvalueTonSavoir)), an open-source, student response system (SRS) developed primarily by students at the École de technologie supérieure (ÉTS).
...
|:---------------|:----------------------------------------------|
| **Utilité**    | Satisfaisante / Très bonne                    |
