...
::: {.callout-note}
This example is explained in detail (with an example in Java) throughout [this blog post](https://modularmoose.org/blog/2023-07-13-parametric).
:::
...
::: {.callout-note}
These relations are explained in detail throughout [this blog post](https://modularmoose.org/developers/predefinedentities/#genericity).
:::
