...
![Drag and drop the model file](/img/posts/drag-drop-model-to-moose.gif){.style="width='100%'"}
...
-   Click on the **Moose Properties** tab to view the Moose properties of this class.
    ...
    ![Inspecting a FamixTypeScriptClass](/img/posts/AnimationMooseInspectModel.gif){.style="width='100%'"}
...
![Roassal visualization of Emojiopoly](/img/posts/VisualisationMooseRoassal.gif){.style="width='100%'"}
